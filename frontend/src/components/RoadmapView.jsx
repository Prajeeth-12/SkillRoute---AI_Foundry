                  ...
                  >
                    ...
                    <div className="relative z-10 flex-shrink-0">
                      <button
                        ...
                        disabled={updating}
                        className={`flex items-center justify-center h-16 w-16 rounded-full font-bold text-xl shadow-lg transition-all transform hover:scale-110 ${
                          isCompleted 
                    ...
                    {/* Content card */}
                    <div className={`flex-1 bg-white dark:bg-zinc-900 border-2 rounded-2xl p-6 shadow-md dark:shadow-none transition-all ${
                      isCompleted 
